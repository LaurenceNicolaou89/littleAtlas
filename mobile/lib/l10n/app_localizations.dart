...
abstract class AppLocalizations {
  ...
  /// No description provided for @weatherOutdoor.
  ///
  /// In en, this message translates to:
  /// **'Great day to be outside!'**
  String get weatherOutdoor;

  /// No description provided for @weatherIndoor.
  ///
  /// In en, this message translates to:
  /// **'Better to stay indoors'**
  String get weatherIndoor;

  /// No description provided for @weatherCaution.
  ///
  /// In en, this message translates to:
  /// **'Be cautious outdoors'**
  String get weatherCaution;
